...
const defaultColors = ['rgba(112, 123, 156, 0.6)', 'rgba(112, 123, 156, 0.4)', 'rgba(112, 123, 156, 0.2)'];
  ...
  useEffect(() => {
    ...
    class AutoDriver {
      ...
      update() {
        ...
        if (this.mouse.isHoverInside && !autoWhileHovered) {
          if (this.active) this.forceStop();
          return;
        }
        if (!this.active) {
